...
@Component({
  ...
  styles: [`
    ...
    .dss-row:hover { background: #F9FAFB; }
    .dss-row--selected { background: #EFF6FF; color: #1E40AF; font-weight: 600; }
    .dss-row--selected:hover { background: #DBEAFE; }

    .dss-row__icon { font-size: 14px; color: #6B7280; }
    .dss-row__icon--action { color: #6B7280; }
    .dss-row__icon--svg {
      display: inline-flex;
      align-items: center;
    ...
    .dss-json-row:hover { background: #F9FAFB; }
    .dss-json-row--selected { background: #EFF6FF; }
    .dss-json-row--object .dss-json-key { color: #1E40AF; font-weight: 700; }
    ...
    .dss-json-insert-array:hover { background: #7E22CE; }
...
export class DataSourceSelectorComponent {
  constructor(private sanitizer: DomSanitizer) {
    const replace = (svg: string) => svg.replace(/#C6CCD6/g, 'currentColor');
    this.icons = {
