      ...
      <div class="cc-input-wrapper" [ngClass]="'cc-input-wrapper--' + state">
        ...
        <span class="cc-icon-wrap">
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
            <circle cx="9" cy="7" r="4" stroke="var(--c-bluegray-700)" stroke-width="1.8"/>
            <path d="M2 21c0-4 3.134-7 7-7s7 3 7 7" stroke="var(--c-bluegray-700)" stroke-width="1.8" stroke-linecap="round"/>
            <path d="M19 8v6M22 11h-6" stroke="var(--c-bluegray-700)" stroke-width="1.8" stroke-linecap="round"/>
          </svg>
        </span>
      </div>
    </div>
...
export const AllStates: Story = {
  ...
  render: () => ({
    template: `
      <div style="display:flex; flex-direction:column; gap:20px; padding:24px; background:var(--c-surface-200); width:320px;">
